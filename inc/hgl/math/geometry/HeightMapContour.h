...
namespace hgl::math
{
     ...
     *
     * @param contours 要处理的轮廓列表
     * @param smooth 是否平滑
     * @param simplify_epsilon 简化容差
     */
    ...
    public:
        ...
        HeightMapContourResult Extract(bool smooth = false, float simplify_epsilon = 0.0f)
        {
            ...
            {
                ProcessContours(result.low_to_mid_contours, smooth, simplify_epsilon);
                ProcessContours(result.mid_to_high_contours, smooth, simplify_epsilon);
            }
