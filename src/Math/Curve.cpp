...
namespace hgl::math
{
    ...
    void CatmullRomSpline::AddPoint(const Vector3f &point)
    {
        control_points.push_back(point);
    }
    
    void CatmullRomSpline::SetPoints(const std::vector<Vector3f> &points)
    {
        control_points = points;
    }
    
    Vector3f CatmullRomSpline::EvaluateSegment(int segment, float t) const
    {
    ...
    Vector3f CatmullRomSpline::Evaluate(float t) const
    {
    ...
    Vector3f CatmullRomSpline::GetSegmentTangent(int segment, float t) const
    {
        Vector3f p0, p1, p2, p3;
    ...
    float CatmullRomSpline::GetLength(int samples_per_segment) const
    {
        if (control_points.size() < 2)
            return 0.0f;
    ...
    int CatmullRomSpline::GetPointCount() const
    {
